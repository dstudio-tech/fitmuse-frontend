  ...
  const getMeData = async (jwt: string) => {
    try {
      const response = await fetch(
        `${backendUrl}/api/users/me?populate[sale][populate][service]=true&populate[collections][filters][publishedAt][$notNull]=true&populate[collections][populate][post_item][populate][cover]=true&populate[collections][populate][post_item][populate][model][populate][avatar]=true&populate[favourites][filters][publishedAt][$notNull]=true&populate[favourites][populate][model][populate][thumbnail]=true`,
        {
          method: "GET",
          headers: {
